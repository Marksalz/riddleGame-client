...
export default function GamePage() {
  ...
  const riddles = riddlesContext.riddles;
  if (riddles == null) {
    throw new Error(
      "Riddles data is null or undefined. Check RiddlesContext provider."
    );
  }
  //console.log(riddles);
  ...
  useEffect(() => {
    console.log(`current riddle index: `, currentRiddleIdx);

    if (isSolved && currentRiddleIdx < riddles.length) {
